...
$.extend({
    message: function (e) {
        ...
        "string" == typeof e && (n.message = e), "object" == typeof e && (n = $.extend({}, n, e));
        var i, o, s, t = n.showClose ? '<div class="c-message--close">×</div>' : "",
            ...
            m = $("body"), d = $(c);
        o = function () {
            d.addClass("slideOutRight"), d.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
                s()
            })
        }, s = function () {
            d.remove(), n.onClose(n), clearTimeout(i)
        }, $(".c-message").remove(), m.append(d), d.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
